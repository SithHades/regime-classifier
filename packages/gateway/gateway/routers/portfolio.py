...
async def calculate_portfolio_risk(
    request: Request,
    holdings: List[Dict] = Body(..., description="List of holdings, e.g. [{'symbol': 'BTC', 'amount': 1.0}]")
):
    ...
    return {
        "portfolio_risk_score": final_risk,
        "details": "Calculated using mock engine (Gateway MVP)"
    }
